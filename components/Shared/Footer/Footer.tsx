    ...
    >
      ...
      <defs>
        ...
        <div className="flex flex-wrap gap-[149px]">
          <div>
            <h3 className={`${inter.className} mb-[19px] text-[#000000] font-[500px]`}>Personal</h3>
            <ul className={`${inter.className}  space-y-2 text-[#00000080] `}>
              <li>Wallet</li>
              <li>Accounts</li>
              <li>Transfers</li>
              <li>Features</li>
          ...
          <div>
            <h3 className={`${inter.className} mb-[19px] text-[#000000] font-[500px]`}>Businesses</h3>
            <ul className={`${inter.className}  space-y-2 text-[#00000080] `}>
              <li>Features</li>
              <li>Payments</li>
              <li>Transfers</li>
          ...
          <div>
            <h3 className={`${inter.className} mb-[19px] text-[#000000] font-[500px]`}>Resources</h3>
            <ul className={`${inter.className}  space-y-2 text-[#00000080] `}>
              <li>Guides</li>
              <li>Docs</li>
            </ul>
