  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-4 md:px-8">
        <h2
          className={`${bebasNeue.className} text-[38px]  md:text-[52px] leading-tight text-[#FFFFFF]`}
        >
        ...
        <div className="w-[748px] h-[187px] grid grid-cols-1  md:grid-cols-3 gap-[20px] mt-[221px]">
          <div className="bg-white  pt-[29px] pb-[29px] pl-[27px] pr-[27px] rounded-lg shadow-md  w-[236px]">
            <FaMapMarkerAlt
              size={40}
              className="text-[#141B34] mb-2 bg-[#F5F5F5] p-[10px] w-[52px] border-[1px] border-[#F5F5F5]  rounded-[12px]"
            />
            <p
              className={`${inter.className} text-[16px] md:text-[18px] text-[#222222] mt-[55px]`}
            >
              IT Vaban, BU
            </p>
          </div>
