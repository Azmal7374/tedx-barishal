  ...
  return (
    <section className="flex flex-col md:flex-row items-center justify-center md:justify-between p-8 md:p-16 gap-8 bg-[#F5F5F5]">
      ...
      <div className="text-center md:text-left max-w-lg space-y-4">
        <h4 className={`${bebasNeue.className} text-[16px] text-[#E91F23]`}>
          THEME OF 2024
        </h4>
        <h1
          className={`${bebasNeue.className} text-[38px]  md:text-[52px] leading-tight text-[#111111]`}
        >
          VOICE OF TODAY, VISION OF TOMORROW
        </h1>
        <p
          className={`${inter.className} text-[16px]  md:text-[18px] leading-tight text-[#4B4B4B]`}
        >
        ...
        <Button
          className={`${inter.className} bg-transparent hover:bg-white  md:w-[220px] h-[50px] border-[#E91F23] text-[#E91F23] hover:text-[#E91F23] border  mt-4 rounded-[8px]   text-[18px] font-[500px]`}
        >
          Partner with us
        </Button>
      </div>
